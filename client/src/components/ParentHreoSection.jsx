                      ...
                      <div className='flex md:px-8 px-3  py-2'>
                          <div   className='  flex gap-5 bg-[#322bff7a] p-6 items-center justify-centere py-2  rounded-xl cursor-pointer  '>
                              <div className='flex justify-between items-center flex-col'>
                                  <div onClick={()=>setIsLOG(true)}   className='md:w-10 md:h-10 bg-[#E0EAFF] md:rounded-full md:flex  p-2 rounded-full   border-2 border-[#6552E3] justify-center items-center'>
